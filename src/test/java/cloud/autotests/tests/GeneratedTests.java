...
public class GeneratedTests extends TestBase {
    ...
    void generatedTest() {
        ...
        step("Выбрать радиобатон 'По электронной почте'", () -> {
            step("// todo: just add selenium action");
        });

        step("Ввести электронную почту 'dfhsjdf@mail.ru'", () -> {
            step("// todo: just add selenium action");
        });

        step("Ввести пароль '325523'", () -> {
            step("// todo: just add selenium action");
        });
        ...
        step("Проверить успешную авторизацию под 'По электронной почте'", () -> {
            step("// todo: just add selenium action");
        });
    }
